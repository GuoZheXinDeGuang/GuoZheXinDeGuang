...
<h3 align="center">A passionate CS & Math junior @ NYU CAS</h3>
...
- **Coding Languages**: Python, Java, C/C++, JavaScript, Typescript, LaTeX  
- **Cloud & Databases**: PostgreSQL, MongoDB  
- **Developer Tools**: VS Code, GitHub  
- **Operating Systems**: Windows, MacOS, Linux  
- **Packages**: ROS, Scikit-learn, Scipy, Numpy, Matplotlib, Pandas, PyTorch, OpenCV, Tensorflow  
